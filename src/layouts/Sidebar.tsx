      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="text-[#868686] flex items-center gap-2">
            {!isCollapsed && <Search className="size-6" />}
            <Button
              variant="ghost"
              size="icon"
        ...
        <div className="mt-8">
          <button
            title="Add Folder"
            className="cursor-pointer text-sm font-semibold w-full flex items-center gap-1 justify-center py-2.5 border border-white/10 rounded-full mb-3"
          >
            <Plus className="size-5" /> {!isCollapsed && "Add Folder"}
          </button>
          <button
            title="Create Chat"
            className="cursor-pointer text-sm font-semibold w-full flex items-center gap-1 justify-center py-2.5 rounded-full bg-[#FFFFFF26]"
          >
      ...
      <div>
        ...
        {!isCollapsed && (
          <div className="bg-[#363636] p-4 rounded-[12px]">
            ...
            <button className="cursor-pointer font-semibold text-sm border border-[#F37F0C] py-2.5 w-full rounded-[56px] mt-3">
              Upgrade plan
            </button>
          </div>
        )}
        ...
        {!isCollapsed && (
          <div className="flex items-center gap-2 my-3 cursor-pointer">
            <div className="rounded-full bg-[#363636] flex items-center justify-center">
              <img
                className="p-2 size-5 w-full h-full"
                src={FlowIcon}
                alt="FlowIcon"
              />
            </div>
